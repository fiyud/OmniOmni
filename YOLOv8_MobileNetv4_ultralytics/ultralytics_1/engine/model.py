...
from ultralytics_1.cfg import TASK2DATA, get_cfg, get_save_dir
from ultralytics_1.engine.results import Results
from ultralytics_1.hub import HUB_WEB_ROOT, HUBTrainingSession
from ultralytics_1.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
...
class Model(nn.Module):
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt", use_dill=True) -> None:
        ...
        from ultralytics_1 import __version__
    ...
    def track(
        ...
        **kwargs,
        ...
        if not hasattr(self.predictor, "trackers"):
            from ultralytics_1.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        """
        self._check_is_pytorch_model()
        from ultralytics_1.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from ultralytics_1.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        """
        from ultralytics_1.nn.autobackend import check_class_names
