...
from ultralytics_1.utils.torch_utils import fuse_conv_and_bn
...
class C2f(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        # self.m = nn.ModuleList(GhostBottleneckV2(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
        self.m = nn.Sequential(*(GhostBottleneckV2(self.c, self.c) for _ in range(n)))
...
class ODGC2f(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        super().__init__()
        self.c = int(c2 * e)  # hidden channels
        self.cv1 = ODConv_3rd(c1, 2 * self.c, 1, 1)
        self.cv2 = ODConv_3rd((2 + n) * self.c, c2, 1)  # optional act=FReLU(c2)
        self.m = nn.Sequential(*(GhostBottleneckV2(self.c, self.c) for _ in range(n)))
...
class C3(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        ...
        self.cv1 = ODConv_3rd(c1, c_, 1, 1)
        self.cv2 = ODConv_3rd(c1, c_, 1, 1)
        self.cv3 = ODConv_3rd(2 * c_, c2, 1)  # optional act=FReLU(c2)
        self.m = nn.Sequential(*(GhostBottleneckV2(c_, c_, shortcut, g, k=((1, 1), (3, 3)), e=1.0) for _ in range(n)))
...
class ABlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=1.2, area=1):
        ...
        self.mlp = nn.Sequential(ODConv_3rd(dim, mlp_hidden_dim, 1), ODConv_3rd(mlp_hidden_dim, dim, 1, act=False))
...
#         self.cv1 = ODConv_3rd(c1, c_, 1, 1)
#         self.cv2 = ODConv_3rd((1 + n) * c_, c2, 1)  # optional act=FReLU(c2)
...
class A2C2f(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, a2=True, area=1, residual=False, mlp_ratio=2.0, e=0.5, g=1, shortcut=True):
        ...
        self.cv1 = ODConv_3rd(c1, c_, 1, 1)
        self.cv2 = ODConv_3rd((1 + n) * c_, c2, 1)
...
class C3k(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5, k=3):
        ...
        self.m = nn.Sequential(*(GhostBottleneckV2(c_, c_, shortcut, g, k=(k, k), e=1.0) for _ in range(n)))
...
class C3k2(C2f):
    ...
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(
            C3k(self.c, self.c, 2, shortcut, g) if c3k else GhostBottleneckV2(self.c, self.c, shortcut, g) for _ in range(n)
        )
