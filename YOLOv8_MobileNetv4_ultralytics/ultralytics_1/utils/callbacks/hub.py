...
from ultralytics_1.hub import HUB_WEB_ROOT, PREFIX, HUBTrainingSession, events
from ultralytics_1.utils import LOGGER, RANK, SETTINGS
...
def on_fit_epoch_end(trainer):
    ...
    if session:
        ...
        if trainer.epoch == 0:
            from ultralytics_1.utils.torch_utils import model_info_for_loggers
